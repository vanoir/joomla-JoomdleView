...
<a href='?aula=".$id1.$youtubeNoMenu."&conteudo=vid'><button class='btn btn-info' style='min-width:85%;'>
	<i class='icon-play icon-white'></i> Assistir vídeo</button></a>  
		<a href='".$umaAula[1]."' download><button class='btn btn-success''>
			<i class='icon-download-alt icon-white'></i></button></a> 
</div>
<br />

<div class='btn-group' style='min-width:100%; text-align:center;'>
<a href='?aula=".$id1.$youtubeNoMenu."&conteudo=man'> <button class='btn btn-info' style='min-width:85%; margin-top: 5px;'>
	<i class=' icon-file icon-white'></i> Abrir manual</button></a> 
		<a href='".$umaAula[3]."' download><button class='btn btn-success' style='margin-top: 5px;'>
